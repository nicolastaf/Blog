    ...
    public function login(){
        ...
        if(isset($_POST['submit'])){
            ...
            if(empty($email) || empty($password)){
                $errors['empty'] = "Tous les n'ont pas été remplis";
            }else{
                ...
                $message = '
                     <html lang="fr" style="font-family: sans-serif;">
                         ...
                         <body>
                             ...
                             Pour terminer votre inscription cliquez<a href="http://www.nicolas-staffent.com/projet4/pages/index.php?controller=admin&page=login"> sur ce lien</a><br><br>
                             Bien cordialement
